...
export type EventExternalPartnerMappingId = Tagged<number, 'EventExternalPartnerMappingId'>;
...
export const toChatId = (value: string): ChatId => toTaggedString<ChatId>(value);
...
export const toEventExternalPartnerMappingId = (
  value: number,
): EventExternalPartnerMappingId => toTaggedInteger<EventExternalPartnerMappingId>(value);
export const toEventId = (value: string): EventId => toTaggedString<EventId>(value);
...
export const toSportId = (value: number): SportId => toTaggedInteger<SportId>(value);
export const toTagId = (value: string): TagId => toTaggedString<TagId>(value);
export const toTeamId = (value: number): TeamId => toTaggedInteger<TeamId>(value);

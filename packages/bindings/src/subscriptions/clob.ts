...
export const MarketBookEventSchema = z.looseObject({
...
export const MarketPriceChangeEventSchema = z.looseObject({
...
export const MarketLastTradePriceEventSchema = z.looseObject({
...
export const MarketTickSizeChangeEventSchema = z.looseObject({
...
export const MarketBestBidAskEventSchema = z.looseObject({
...
export const NewMarketEventSchema = z.looseObject({
...
export const MarketResolvedEventSchema = z.looseObject({
...
export const UserOrderEventSchema = z.looseObject({
...
export const UserTradeEventSchema = z.looseObject({
...
export const TradingEventSchema = z.union([MarketEventSchema, UserEventSchema]);
